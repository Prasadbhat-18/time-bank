(() => {
  ...
  function useGeolocation() {
    ...
    const requestLocationPermission = (0, import_react.useCallback)(async () => {
      try {
        let requestHighAccuracyLocation = function() {
          const geoOptions = {
    ...
    const refreshLocation = (0, import_react.useCallback)(() => {
